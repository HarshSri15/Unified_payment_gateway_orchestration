      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
          ...
          <div className="space-y-3">
            <a
              href={`${import.meta.env.VITE_API_BASE_URL}/api/auth/google`}
              className="flex items-center justify-center w-full bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-medium py-3 px-4 rounded-lg"
            >
              <img src="/google.svg" className="w-5 h-5 mr-3" />
              Sign up with Google
            </a>

            <a
              href={`${import.meta.env.VITE_API_BASE_URL}/api/auth/facebook`}
              className="flex items-center justify-center w-full bg-blue-600 text-white py-3 px-4 rounded-lg"
            >
              <img src="/facebook.svg" className="w-5 h-5 mr-3 invert" />
              Sign up with Facebook
            </a>

            <a
              href={`${import.meta.env.VITE_API_BASE_URL}/api/auth/linkedin`}
              className="flex items-center justify-center w-full bg-blue-700 text-white py-3 px-4 rounded-lg"
            >
              <img src="/linkedin.svg" className="w-5 h-5 mr-3 invert" />
              Sign up with LinkedIn
            </a>
          </div>
